  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-6 form-group">
        <div class="card card-primary card-outline" style="height: 100%;">
          <div class="card-header">
            <h3 class="card-title"><b>Total Pendapatan 2022</b></h3>
            <div class="card-tools">
              <button type="button" class="btn btn-default btn-tool" data-card-widget="collapse">
                <i class="fas fa-minus"></i>
              </button>
      ...
      <div class="col-md-12 form-group ">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <a href="{{ url('admin-sukajadi/kamar/tidak tersedia') }}" style="color: black;">
              <div class="info-box mb-3">
                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-bed"></i></span>

                <div class="info-box-content">
                  <span class="info-box-text">Kamar Tidak Tersedia</span>
                  <span class="info-box-number">
                    {{ $room_notav }}
                    <small>kamar</small>
                  </span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <a href="{{ url('admin-sukajadi/kamar/maintenance') }}" style="color: black;">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Kamar Pemeliharaan</span>
                  <span class="info-box-number">
                    {{ $room_mtc }}
                    <small>kamar</small>
                  </span>
              ...
              <div class="card-body">
                ...
                <div class="col-md-12">
                  <p class="mb-0" style="font-size: 14px;">
                    <a href="{{ url('admin-master/laporan/reservasi') }}" class="btn btn-default fw-bold">
