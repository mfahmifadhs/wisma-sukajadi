      ...
      <div class="modal fade" id="modal-filter">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{ url('admin-sukajadi/kamar/laporan') }}" method="POST">
              @csrf
              ...
              <div class="modal-footer justify-content-between">
                <span class="float-left">
                  <a href="{{ url('admin-sukajadi/kamar/laporan') }}" class="btn btn-danger btn-sm"><i class="fas fa-sync"></i> Muat</a>
                </span>
