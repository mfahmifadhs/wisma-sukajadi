...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapse">
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="https://raw.githubusercontent.com/mfahmifadhs/wisma-sukajadi/master/public/images/admin/logo-admin-mini.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
