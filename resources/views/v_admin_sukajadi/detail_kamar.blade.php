          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="active tab-pane" id="information">
                <form method="POST" action="{{ url('admin-sukajadi/kamar/update/informasi-kamar') }}">
                  @csrf
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="number" class="form-control" name="room_capacity" value="{{ $room->room_capacity }}" min="1">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <button type="submit" class="btn btn-primary float-right mt-4" onclick="return confirm('Ubah informasi kamar ini ?')">
              ...
              <div class="tab-pane" id="rental-rate">
                <form method="POST" action="{{ url('admin-sukajadi/kamar/update/tarif-sewa') }}">
                  @csrf
                  <input type="hidden" name="room_id" value="{{ $room->id_room }}">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="number" class="form-control" name="price[]" value="{{ $rentalrate->price }}" min="1">
                      </div>
                    </div>
                    @endforeach
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <button type="submit" class="btn btn-primary float-right mt-4" onclick="return confirm('Ubah harga tarif sewa kamar ini ?')">
                          <i class="fas fa-edit"></i> Submit
                        </button>
                      </div>
                    </div>
              ...
              <div class="tab-pane" id="history">
                <table class="table m-0">
                  ...
                  <tbody class="text-capitalize">
                    ...
                    <tr>
                      <td><a href="{{ url('admin-sukajadi/reservasi/detail/'. $history->id_reservation) }}">{{ $history->billing_code }}</a></td>
