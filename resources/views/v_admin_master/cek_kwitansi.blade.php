        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
              From
              <address>
                <strong>Wisma master Bandung</strong><br>
                Jl. master No.155, Cipedes, <br>
                Kec. master, Kota Bandung. <br>
                Telp: (022) 2031152
              </address>
            </div>
            <!-- /.col -->
          ...
          <div class="row no-print">
            <div class="col-12">
              <a href="{{ url('admin-master/kwitansi/cetak/'. $reservasi->id_reservation) }}" rel="noopener" target="_blank" class="btn btn-primary float-right" style="margin-right: 5px;">
