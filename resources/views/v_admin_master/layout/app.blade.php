...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="navbar-nav">
        <a href="{{ url('admin-master/reservasi/buat') }}" title="Reservasi Kamar" class="nav-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('admin-master/kamar/daftar/keseluruhan') }}" class="nav-link">
              <i class="nav-icon fas fa-bed"></i>
              <p >Daftar Kamar</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-master/pendapatan/daftar/keseluruhan') }}" class="nav-link">
              <i class="nav-icon fas fa-wallet"></i>
              <p >Daftar Pendapatan</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-master/pengguna/daftar/keseluruhan') }}" class="nav-link">
              <i class="nav-icon fas fa-users"></i>
              <p >Daftar Pengguna</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-master/reservasi/daftar/keseluruhan') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ url('admin-master/laporan/buku-tamu') }}" class="nav-link {{ Request::is('admin-master/laporan/buku-tamu') ? 'active' : '' }}">
              <i class="nav-icon fas fa-file-alt"></i>
              <p>Laporan Buku Tamu</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-master/laporan/kamar') }}" class="nav-link {{ Request::is('admin-master/laporan/kamar') ? 'active' : '' }}">
              <i class="nav-icon fas fa-file-alt"></i>
              <p>Laporan Kamar</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-master/laporan/pnbp') }}" class="nav-link {{ Request::is('admin-master/laporan/pnbp') ? 'active' : '' }}">
              <i class="nav-icon fas fa-file-alt"></i>
              <p>Laporan PNBP</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-master/laporan/reservasi') }}" class="nav-link {{ Request::is('admin-master/laporan/reservasi') ? 'active' : '' }}">
              <i class="nav-icon fas fa-file-alt"></i>
