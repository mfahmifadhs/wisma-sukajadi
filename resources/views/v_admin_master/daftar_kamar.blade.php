          ...
          <div class="card-body p-0">
            <ul class="nav nav-pills flex-column">
              ...
              <li class="nav-item text-capitalize">
                <a href="{{ url('admin-master/kamar/daftar/'. $totals->room_status) }}" class="nav-link">
            ...
            <div class="card card-primary card-outline" style="height: 100%;">
              ...
              <div class="card-footer">
                <span class="float-right">
                  <a href="{{ url('admin-master/kamar/detail/'. $room->id_room) }}" class="btn btn-primary"><i class="fas fa-info-circle"></i> Detail</a>
                </span>
              </div>
            </div>
          </div>
