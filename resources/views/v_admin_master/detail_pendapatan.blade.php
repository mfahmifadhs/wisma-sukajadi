    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="{{ url('admin-master/pendapatan/daftar/keseluruhan') }}">Pendapatan</a></li>
            ...
            <table id="table-1" class="table table-bordered table-striped">
              ...
              <tbody class="text-center">
                ...
                <tr>
                  ...
                  <td class="pt-2">
                    <a href="{{ url('admin-master/reservasi/detail/'. $income->id_reservation) }}" class="btn btn-primary btn-xs">
