    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ url('admin-master/kamar/daftar/keseluruhan') }}">Daftar Kamar</a></li>
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="active tab-pane" id="information">
                <form method="POST" action="{{ url('admin-master/kamar/update/informasi-kamar') }}">
                  @csrf
              ...
              <div class="tab-pane" id="rental-rate">
                <form method="POST" action="{{ url('admin-master/kamar/update/tarif-sewa') }}">
                  @csrf
                  <input type="hidden" name="room_id" value="{{ $room->id_room }}">
                  <div class="card-body">
              ...
              <div class="tab-pane" id="history">
                <table class="table m-0">
                  ...
                  <tbody class="text-capitalize">
                    ...
                    <tr>
                      <td><a href="{{ url('admin-master/reservasi/detail/'. $history->id_reservation) }}">{{ $history->billing_code }}</a></td>
