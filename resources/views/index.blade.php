          ...
          <h3 class="into-sub-title mb-lg-4">Penilaian</h3>
            ...
            <div id="testimonial-slide" class="testimonial-slide">
              ...
              <div class="item">
                <div class="quote-item">
                    <span class="quote-text">
                      Pelayanan staff ramah, security GC banget buat parkirin, kamar bersih rapih
                    </span>
              ...
              <div class="item">
                <div class="quote-item">
                    <span class="quote-text">
                      Ini murah sekali menginap disini. penginapan paling murah
                    </span>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            <div class="ts-service-image-wrapper">
              <img loading="lazy" class="w-100" src="{{ asset('images/main/services/kategori-1.png') }}" alt="service-image">
            </div>
            <div class="d-flex">
              <div class="ts-service-box-img">
                  <img loading="lazy" src="https://cdn-icons.flaticon.com/png/512/2946/premium/2946766.png?token=exp=1659433478~hmac=8ebefdcad634ec544e7041cece6b3ee5" width="50" alt="service-icon">
              </div>
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="service-single.html">Kategori Bisnis</a></h3>
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            <div class="ts-service-image-wrapper">
              <img loading="lazy" class="w-100" src="{{ asset('images/main/services/kategori-2.png') }}" alt="service-image">
            </div>
            <div class="d-flex">
              <div class="ts-service-box-img">
                  <img loading="lazy" src="https://cdn-icons.flaticon.com/png/512/2946/premium/2946766.png?token=exp=1659433478~hmac=8ebefdcad634ec544e7041cece6b3ee5" width="50">
              </div>
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="service-single.html">Kategori Non Bisnis</a></h3>
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            <div class="ts-service-image-wrapper">
              <img loading="lazy" class="w-100" src="{{ asset('images/main/services/kategori-3.png') }}" alt="service-image">
            </div>
            <div class="d-flex">
              <div class="ts-service-box-img">
                  <img loading="lazy" src="https://cdn-icons.flaticon.com/png/512/2946/premium/2946766.png?token=exp=1659433478~hmac=8ebefdcad634ec544e7041cece6b3ee5" width="50" alt="service-icon">
              ...
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="service-single.html">Kategori Sosial</a></h3>
