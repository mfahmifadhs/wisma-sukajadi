...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="navbar-nav">
        <a href="{{ url('admin-pnbp/reservasi/buat') }}" title="Reservasi Kamar" class="nav-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('admin-pnbp/dashboard') }}" class="nav-link {{ Request::is('admin-pnbp/dashboard') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ url('admin-pnbp/kamar/daftar/keseluruhan') }}" class="nav-link">
              <i class="nav-icon fas fa-bed"></i>
              <p>Kamar</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-pnbp/pendapatan/daftar/keseluruhan') }}" class="nav-link">
              <i class="nav-icon fas fa-wallet"></i>
              <p>Pendapatan</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('admin-pnbp/reservasi/daftar/keseluruhan') }}" class="nav-link">
