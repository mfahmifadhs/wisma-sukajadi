    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ url('admin-pnbp/reservasi/daftar/keseluruhan') }}">Reservasi</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="card card-primary card-outline">
          ...
          <!-- /.card-header -->
          <form action="{{ url('admin-pnbp/reservasi/proses-pembayaran/'. $reservasi->id_reservation) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer">
              ...
              @else
              <div class="float-left">
                <a href="{{ url('admin-pnbp/reservasi/daftar') }}" type="reset" class="btn btn-default">
...
<script>
  ...
  $(document).on('change', '.category', function() {
    ...
    if (rentalrateid) {
      $.ajax({
        type: "GET",
        url: "/admin-pnbp/json-get-category?rentalrateid=" + rentalrateid,
        dataType: 'JSON',
  ...
  $(document).on('change', '.price', function() {
    ...
    if (category) {
      $.ajax({
        type: "GET",
        url: "/admin-pnbp/json-get-price?roomid=" + roomid,
        data: {
