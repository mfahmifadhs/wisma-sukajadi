      ...
      <div class="card-body">
        <table id="table-1" class="table table-bordered table-striped">
          ...
          <tbody class="text-capitalize text-center">
            ...
            <tr class="clickable-row" data-href="{{ url('admin-pnbp/reservasi/detail/'.$reservasi->id_reservation) }}">
              <td class="pt-4">{{ $no++ }}</td>
              ...
              <td class="pt-3 text-center">
                @if($reservasi->payment_status == 'belum bayar')
                  ...
                  @else
                  <a href="{{ url('admin-pnbp/reservasi/pembayaran/'.$reservasi->id_reservation) }}" class="btn btn-success btn-xs" 
                ...
                @elseif($reservasi->payment_status == 'sudah bayar')
                  ...
                  <a href="{{ url('admin-pnbp/reservasi/detail/'.$reservasi->id_reservation) }}" class="btn btn-primary btn-xs">
                  ...
                  <a href="{{ url('admin-pnbp/kwitansi/cek/'.$reservasi->id_reservation) }}" class="btn btn-primary btn-xs" 
